#
#  Be sure to run `pod spec lint LSToolsKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/Lius1104/LSToolsKit"
  ...
  # Or just: spec.author    = "Lius"
  # spec.authors            = { "Lius" => "" }
  # spec.social_media_url   = "https://twitter.com/Lius"
  ...
  spec.source       = { :git => "https://github.com/Lius1104/LSToolsKit.git", :tag => "#{spec.version}" }
  ...
  spec.subspec 'UIKit' do |ss|
    ...
    ss.public_header_files = "LSToolsKit/UIKit/**/*.h"
    ss.source_files = "LSToolsKit/UIKit/**/*.{h,m}"
